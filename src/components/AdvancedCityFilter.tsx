...
import { Search, Filter, MapPin, TrendingUp, TrendingDown, DollarSign, Users, Building } from 'lucide-react';
import { CityData } from '../types/city';

interface AdvancedCityFilterProps {
  cities: CityData[];
...
export function AdvancedCityFilter({ cities, onCitySelect, selectedCity }: AdvancedCityFilterProps) {
  ...
  const filteredAndSortedCities = useMemo(() => {
    let filtered = cities.filter(city => {
      ...
      return matchesSearch && matchesCost && matchesSalary && matchesContinent && isAffordable;
    });
